...
class _OpenWidgetState extends State<OpenWidget> {
  ...
  //         ..addListener(() {
  //           setState(() {
  //             isAppBarCollapsed = controller.position.pixels >= kToolbarHeight;
  //           });
  //         }),
  //       slivers: [
  //         SliverAppBar(
  //           expandedHeight: 30.vh,
  //           collapsedHeight: 10.vh,
  //           pinned: true,
  ...
  //             title: Container(
  //               width: 100.vw,
  //               margin: isAppBarCollapsed
  //                   ? const EdgeInsets.all(0)
  //                   : EdgeInsets.all(10.w),
  //               padding: isAppBarCollapsed
  //                   ? const EdgeInsets.all(0)
  //                   : EdgeInsets.all(10.w),
  //               decoration: ShapeDecoration(
  //                 shape: RoundedRectangleBorder(
  ...
  //                 ),
  //                 color:
  //                     isAppBarCollapsed ? Colors.transparent : Colors.black54,
  //               ),
  //               child: Text(
  //                 widget.news.title,
  //                 style: const TextStyle(color: Colors.white),
  //                 textAlign: TextAlign.center,
  //                 maxLines: isAppBarCollapsed ? 1 : 5,
  //                 overflow: TextOverflow.ellipsis,
  //               ),
  //             ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // SizedBox(height: 10.h),
                          // Text(
                          //   "Posted by: ${poster?.posterName ?? 'Unknown'}",
                          //   style: TextStyle(
                          //     fontSize: 16.sp,
                          //   ),
                          // ),
                          // SizedBox(height: 10.h),
                          // Text(
                          //   "Published: ${convertDateString(widget.news.timestamp!.toString())}",
                          //   style: TextStyle(
                          //     fontSize: 16.sp,
                          //   ),
                          // ),
